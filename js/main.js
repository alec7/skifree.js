...
var imageSources = [ '/skifree/sprite-characters.png', '/skifree/skifree-objects.png' ];
var global = this;
...
function createGameSession(game) {
  ...
  $.ajax({
    ...
    url: '/spill/skifree',
    dataType: 'json',
    data: {action: 'session', userId: USER_ID},
...
function gameOver() {
  $.ajax({
    ...
    url: '/spill/skifree',
    dataType: 'json',
    data: {action: 'gameover', userId: USER_ID, token: USER_TOKEN, score: distanceTravelledInMetres}
  }).done(function(response) {
    resetGame();
  });
}
